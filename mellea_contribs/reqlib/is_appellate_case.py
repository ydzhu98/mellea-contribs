...
def court_abbv_from_citation(citation: str) -> str:
    ...
    if match:
        ...
        court_text = re.sub(r'\s*\d{4}$', '', court_text)   # remove year if it's at the end
        return court_text
...
def is_appellate_court_abbv(court_abbv: str) -> ValidationResult:
    ...
    if any(indicator in court_lower for indicator in ['u.s.', 'supreme', 'sup.', 's.ct.']):
    ...
    state_supreme_abbrevs = {
        ...
        'd.c.', 'fla.', 'ga.', 'haw.', 'idaho', 'ill.', 'ind.', 'iowa', 'kan.',
        'ky.', 'la.', 'me.', 'md.', 'mass.', 'mich.', 'minn.', 'miss.', 'mo.',
        'mont.', 'neb.', 'nev.', 'n.h.', 'n.j.', 'n.m.', 'n.y.', 'n.c.', 'n.d.',
        'ohio', 'okla.', 'or.', 'pa.', 'r.i.', 's.c.', 's.d.', 'tenn.', 'tex.',
...
def is_appellate_case(ctx: Context, folder_path: str) -> ValidationResult:
    ...
    try:
        ...
        return is_appellate_court_fullname(get_court_from_case(input, load_jsons_from_folder(folder_path)))

...
def test_long_user_prompt_and_context(user_prompt, grounding_context, example_name):
    ...
    pass_condition = (user_prompt.strip().splitlines()[0] in content) and (context_key_check in content)
    print("PASS?", pass_condition)
...
if __name__ == "__main__":
    ...
    test_long_user_prompt_and_context(tap_user_prompt, tap_grounding_context, "TaP / SRE Example")
    ...
    test_long_user_prompt_and_context(weather_user_prompt, weather_grounding_context, "Weather Agent Example")
